        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuestionPhone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    CopyrightName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CopyrightLink = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    FooterContent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirstHead = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    FirstTitle = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    SecondHead = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SecondTitle = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ThirdHead = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ThirdTitle = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassDuration = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    SkillLevel = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Language = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Student = table.Column<int>(type: "int", nullable: false),
                    Assesment = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
